...
<form action="<?php echo bUrl('updateItem')?>" method="post" id="update_form" enctype="multipart/form-data" class="form-horizontal" role="form">
    <?php echo textOption("圖片解說","title",$edit_data); ?>
    ...
    <div style="display:none;"><?php echo textOption("排序","sort",$edit_data); ?>   </div>
    ...
    <div class="clearfix form-actions">
        <div class="col-md-offset-3 col-md-9">
            <a class="btn" href="<?php echo bUrl('itemList',TRUE,array('album_sn')) ?>">
                <i class="icon-undo bigger-110"></i> 回上一頁
            </a>
            &nbsp; &nbsp; &nbsp;
            <button class="btn btn-info" type="Submit">
                <i class="icon-ok bigger-110"></i> 送出
            </button>
        </div>
    </div>
</form>
