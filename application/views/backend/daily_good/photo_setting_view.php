...
<div class="row">
	<div class="col-xs-12 form-horizontal">
		<div class="form-group">
			<label class="col-xs-12 col-sm-2 control-label no-padding-right" for="url">發起人姓名</label>
			<div class="col-xs-12 col-sm-8"><span style='font-weight:bold'><?php echo tryGetData('title',$content_info); ?></span></div>
		</div>
		
		<div class="form-group">
			<label class="col-xs-12 col-sm-2 control-label no-padding-right" for="url">資料來源</label>
			<div class="col-xs-12 col-sm-8"><span style='font-weight:bold'><?php echo tryGetData('brief',$content_info); ?></span></div>
		</div>
		...
		<input type='hidden' name='content_sn' value='<?php echo tryGetData('sn', $content_info); ?>'>		
			<div class="form-group">
				...
				<div class="col-xs-12 col-sm-6"><input type='file' id='filename' name='img_filename' size=20>
				<span class="note">只允許上傳jpg,png,gif 格式圖檔及PDF</span>
			</div>
			</div>
			<div class="form-group">
